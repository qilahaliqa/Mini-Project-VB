...
Begin VB.Form frmDelete 
   ...
   Begin MSDataGridLib.DataGrid dbgDelete 
      Bindings        =   "frmDelete.frx":214F0
      Height          =   3975
      Left            =   600
      TabIndex        =   2
      Top             =   960
...
Private Sub cmdDelete_Click()
     strMsg = MsgBox("Are you sure want to delete all the information?", vbYesNo, "Warning")
     If strMsg = vbYes Then
        Adodc1.Recordset.Delete
        MsgBox "File succesfully deleted", vbExclamation, "File Deleted"
     Else
        MsgBox "Deleting Cancel", vbOKOnly, "Cancel"
     End If
End Sub
